...
export const KadInteraction = {
  focus(element, canv = null) {
    if (canv != null) canv.loop();
    KadLog.errorChecked(!element.isKadElement, "focus needs an KadElement generated by initEL!");
    element.HTML.focus();
  },
  unfocus(element, canv) {
    if (canv != null) {
      canv.noLoop();
      canv.redraw();
    }
    KadLog.errorChecked(!element.isKadElement, "blur needs an KadElement generated by initEL!");
    element.HTML.blur();
  },
  removeContextmenu(element) {
    KadLog.errorCheckedLevel(!element.isKadElement, 2, "removeContextmenu needs an KadElement generated by initEL!");
    element.HTML.oncontextmenu = function () {
      return false;
    };
  },
};
